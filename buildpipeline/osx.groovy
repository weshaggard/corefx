...
simpleNode('OSX10.12','latest') {
    ...
    def commonprops = "--ci --preparemachine /p:ArchGroup=x64 /p:ConfigurationGroup=${params.CGroup}"
    ...
    stage ('Build Tests') {
        ...
        sh "HOME=\$WORKSPACE/tempHome ./eng/build-tests.sh ${commonprops} /p:SkipTests=true /p:ArchiveTests=true /p:EnableDumpling=true${additionalArgs}"
    }
