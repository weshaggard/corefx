...
simpleDockerNode('microsoft/dotnet-buildtools-prereqs:centos-6-376e1a3-20174311014331') {
    ...
    def commonprops = "/p:ArchGroup=${params.AGroup} /p:ConfigurationGroup=${params.CGroup}"
    ...
    stage ('Build Tests') {
        ...
        sh "LD_LIBRARY_PATH=/usr/local/lib ./eng/build-tests.sh ${commonprops} /p:SkipTests=true /p:ArchiveTests=true /p:EnableDumpling=true /p:PortableBuild=false${additionalArgs}"
    }
